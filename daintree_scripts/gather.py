...
def _gather_and_upload(save_pref: Path, ipt_dict: dict, model_name:str, screen_name:str):
    ...
    df_ensemble, df_predictions = data_processor.gather_ensemble_tasks(save_pref,
